...
public class TestDataGeneration {
    ...
    public void testDataDeSerialization() throws IllegalAccessException {
        ...
        for (int i = 0; i < fields.length; i++) {
            ...
            String expected = getString(i, type, field);
            Assert.assertEquals(actual, expected);
        }
    }

    private static String getString(int i, Class<?> type, Field field) {
        String expected = (i + 1) + "";
    ...
    public void test_generic_functionality(){
        ...
        SimplePOJOArray expected = simplePOJOArray.fromXml(actualXml);
        ...
        SimplePOJOArray actual3 = simplePOJOArray.fromXml(actualXml);
        SimplePOJOArray expected3 = new SimplePOJOArray().fromResource("simple_pojo_array_data.xml");
